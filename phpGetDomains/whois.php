...
==========================================================================
Author:      php easy code, www.phpeasycode.com (mod for php short tag off - Ap.Muthu)
Web Site:    http://www.phpeasycode.com
Contact:     webmaster@phpeasycode.com
*************************************************************************/
/*
New .com url is http://registrar.verisign-grs.com/webwhois-ui/
Not Visible if in: http://www.net4.in/net4app/aspx/domains/whois.aspx
*/
...
<p><b><label for="domain">Domain/IP Address:</label></b> <input type="text" name="domain" id="domain" value="<?php echo $domain; ?>"> <input type="submit" value="Lookup"></p>
</form>
<?php
if($domain) {
	$domain = trim($domain);
